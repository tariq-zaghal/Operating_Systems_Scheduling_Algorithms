...
for i in range(1, n + 1):
    ...
    if processing:
        ...
        if (current_process.burst_time == 0):
            ...
            current_process.add_start_end_pair(start, step)
    ...
    if processing == False and len(cpu_queue) > 0:
        current_process = cpu_queue.pop(0)
        processing = True
        done = False
        start = i
...
Plotter.plot(processes, "Round Robin Plot")

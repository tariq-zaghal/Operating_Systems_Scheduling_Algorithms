...
for i in range(1, n + 1):
    ...
    if processing:
        ...
        elif len(cpu_queue) > 0:
            minimum = cpu_queue[0]
            for process in cpu_queue:
                if process.burst_time < minimum.burst_time:
                    minimum = process

            if minimum.burst_time < current_process.burst_time:
                end = i - start
                ...
                current_process = minimum
                cpu_queue.remove(minimum)
                start = i
...
print("For Shortest Time Remaining Scheduling:\n")
...
Plotter.plot(processes, "Shortest Time Remaining Plot")

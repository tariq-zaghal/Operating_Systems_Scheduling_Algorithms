...
for i in range(1, n + 1):
    ...
    if processing:
        ...
        if current_process.burst_time == 0:
            ...
            minimum = cpu_queue[0]
            for process in cpu_queue:
                if process.priority < minimum.priority:
                    minimum = process

            if minimum.priority < current_process.priority:
                end = i - start
...
print("For Preemptive Priority Scheduling:\n ")
...
Plotter.plot(processes, "Preemptive Priority Plot")
